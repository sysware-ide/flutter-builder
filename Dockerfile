...
# download canvaskit
RUN mkdir /canvaskit  && \
    wget https://unpkg.com/canvaskit-wasm/bin/canvaskit.wasm -O /canvaskit/canvaskit.wasm && \
    wget https://unpkg.com/canvaskit-wasm/bin/canvaskit.js -O /canvaskit/canvaskit.js
